...
?>
	...
	<?php while( have_rows('slider') ): the_row(); 
		...
		$slide_sticker_title = get_sub_field('slide_sticker_title');
		$slide_sticker_subtitle = get_sub_field('slide_sticker_subtitle');
		$slide_sticker_price = get_sub_field('slide_sticker_price');
	?>
		...
		<div class="slide-item">
			...
			<div class="container">
				...
				<div class="row">
					...
					<?php if( $slide_sticker_price ): ?>
						<div class="circle text-center align-center bg-yellow" data-animation="fadeIn" data-delay="1s">
							<p class="text-uppercase"><?php echo $slide_sticker_title; ?></p>
							<p class="slide-price">£<?php echo $slide_sticker_price; ?></p>
							<p class="small"><?php echo $slide_sticker_subtitle; ?></p>
						</div>
					<?php endif; ?>
					</div>
					<div class="col-md-4">
	...
	<div class="container">
		<div class="row">
			<?php while( have_rows('home_banners') ): the_row(); 
				...
				$home_banner_title = get_sub_field('home_banner_title');
					...
					<div class="img-wrap">
						...
						<div class="overlay">
							<div class="vertical-align-center">
								<h2 class="white"><?php echo $home_banner_title; ?></h2>
								<a href="<?php echo $home_banner_button_link; ?>" class="btn text-uppercase"><?php echo $home_banner_button_text; ?></a>
							</div>
						</div>
					</div>
...
<div id="response">	
<?php echo do_shortcode( '[products limit="12" columns="4" orderby="rand" order="DESC" class="quick-sale"  ]' ); ?>
</div>
