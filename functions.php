...
if ($vendor) {
   ...
   // echo '<div class="img-wrap"><a target="_blank" href="' . $vendor->permalink . '">';
    if($getuser == 'yessselectrical'){
                            echo '<div class="img-wrap"><a href="https://www.buyrointe.co.uk/yesss-electrical/" >';
                        } elseif ($getuser == 'heatershop') {
                            echo '<div class="img-wrap"><a href="https://www.buyrointe.co.uk/heater-shop/" >';
                        } elseif ($getuser == 'kewelectrical') {
                            echo '<div class="img-wrap"><a href="https://www.buyrointe.co.uk/kew-electrical/" >';
    }
