			...
			<?php if( is_woocommerce() || is_front_page() ): ?>
				...
				<div id="footer-products">
					<div class="ultra-wide-container">
						<div class="container">
							<h1 class="text-center text-uppercase"><?php _e('most sold'); ?></h1>
							<?php echo do_shortcode( '[products limit="5" columns="5" orderby="date" order="DESC" class="quick-sale"  ]' ); ?>
						</div>
					</div>
				</div>
			<?php endif; ?>
				...
				<div class="ultra-wide-container">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-3">
								<h4 class="footer-title text-uppercase"><?php _e('connect with us'); ?></h4>
